...
namespace Hanhua.TextEditTools.RfoRunEfactory
{
    ...
    /// 符文工房边境文本编辑器
    /// </summary>
    public partial class RfoRunEfactoryTextEditor : BaseTextEditor
    {
        #region " 本地变量 "
        ...
        /// 初始化
        /// </summary>
        public RfoRunEfactoryTextEditor()
        {
            InitializeComponent();

            this.ResetHeight();

            this.gameName = "RfoRunEfactory";
            this.baseFolder = @"E:\Game\ISO\Wii\符文工房边境";
            //this.baseFolder = @"G:\游戏汉化\符文工房边境";
